...
static mc_nbt_value_t* mc_nbt__create(const char* name,
                                      int name_len,
                                      mc_nbt_type_t type,
                                      int additional_payload);
static mc_nbt_value_t* mc_nbt__create_vl(mc_nbt_type_t type,
                                         const char* name,
                                         int name_len,
                                         int len);
...
mc_nbt_value_t* mc_nbt_create_compound(const char* name,
                                       int name_len,
                                       int len) {
...
mc_nbt_value_t* mc_nbt__create(const char* name,
                               int name_len,
                               mc_nbt_type_t type,
                               int additional_payload) {
  mc_nbt_value_t* res;
...
mc_nbt_value_t* mc_nbt__create_vl(mc_nbt_type_t type,
                                  const char* name,
                                  int name_len,
                                  int len) {
  mc_nbt_value_t* res;
